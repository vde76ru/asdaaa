...
class EnhancedUnifiedExchangeClient:
    ...
    async def get_klines(self, symbol: str, interval: str = '1m', limit: int = 500) -> Optional[pd.DataFrame]:
        ...
        try:
            ...
            klines = self.bybit_integration.v5_client.get_kline(
                category="linear",
                symbol=symbol,
                interval=interval,
                limit=limit
    ...
    async def get_ticker(self, symbol: str) -> Dict[str, Any]:
        ...
        try:
            ...
            ticker = self.bybit_integration.v5_client.get_tickers(
                category="linear",
                symbol=symbol
            )
    ...
    async def get_order_book(self, symbol: str, limit: int = 20) -> Dict[str, Any]:
        ...
        try:
            ...
            orderbook = self.bybit_integration.v5_client.get_orderbook(
                category="linear",
                symbol=symbol,
                limit=limit
            )
